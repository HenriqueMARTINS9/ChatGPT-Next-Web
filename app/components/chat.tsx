...
import { DatePicker, Calendar, Cascader, Rate, ColorPicker, ColorPickerProps, Form,Input,InputNumber,Radio,Select,Slider,Switch,TreeSelect,Upload, Button, Checkbox } from 'antd';
                  ...
                  <div className={styles["chat-message-item"]}>
                    ...
                    {typeof message.content === 'string' && message.content.toLowerCase().includes("date") && (
                      <div className={styles["chat-datepicker"]}>
                        <DatePicker  picker="time" onChange={(date, dateString) => {
                          console.log(date);
                          console.log(dateString);
                        }}/>
                        <DatePicker  picker="date" onChange={(date, dateString) => {
                          console.log(date);
                          console.log(dateString);
                        }}/>
                    ...
                    {typeof message.content === 'string' && message.content.toLowerCase().includes("form") && (
